	...
	*/
	class adminlogin
	{
		...
		public function longin_admin($adminUser,$adminPass){
			...
			$adminPass = md5(mysqli_real_escape_string($this->db->link, $adminPass)); //mysqli gọi 2 biến. (adminUser and link) biến link -> gọi conect db từ file db
			...
			if(empty($adminUser) || empty($adminPass)){
				...
				if($result != false){
                    ...
                    Session::set('RankId', $value['RankId']);
